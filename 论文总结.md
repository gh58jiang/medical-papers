...
***
**[2]** Kuck, Jonathan, et al. "**Query-based outlier detection in heterogeneous information networks.**" Advances in database technology: proceedings. International Conference on Extending Database Technology. Vol. 2015. NIH Public Access, 2015.
